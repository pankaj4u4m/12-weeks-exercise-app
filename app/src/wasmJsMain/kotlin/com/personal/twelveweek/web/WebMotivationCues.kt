...
fun webIsStretchSection(sectionTitle: String): Boolean {
...
fun webMotivationTagsFor(exerciseName: String, sectionTitle: String, ordinal: Int = 0, total: Int = 0): Set<String> {
    val text = "$exerciseName $sectionTitle".lowercase()
    val tags = mutableSetOf<String>()

    if (webIsStretchSection(sectionTitle)) return setOf(STRETCH)
